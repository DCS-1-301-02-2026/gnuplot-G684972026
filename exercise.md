...
plot "weather2026.csv" u 1:2 w lp t  "最高気温","" u 1:3 w lp t "最高気温(平年)",""u 1:4 w lp t "最低気温","" u 1:5 w lp t "最低気温(平年)"
```
...
set ylabel"人"
set xlabel"誕生日"
plot "bm.txt" using 1:2:xtic(1) with boxes fc rgb "skyblue"
